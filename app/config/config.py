...
def load_config():
    # fix: IsADirectoryError: [Errno 21] Is a directory: '/AI-NewMedia/config.toml'
...
project_name = _cfg.get("project_name", "AI-NewMedia")
project_description = _cfg.get(
    "project_description",
    "<a href='https://github.com/bruceleeu-creator/AI-NewMedia'>https://github.com/bruceleeu-creator/AI-NewMedia</a>",
)
